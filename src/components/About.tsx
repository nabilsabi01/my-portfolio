    ...
    <section id="about" className="py-20 bg-white relative">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          Développeur Full Stack passionné, spécialisé en Java/Angular avec
          une solide formation en développement informatique. Actuellement en
          formation à l'École Numérique Ahmed AL HANSALI/Simplon, je combine
          expertise technique et créativité pour développer des solutions web
          innovantes.
          </p>
        </div>
